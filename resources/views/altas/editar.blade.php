...
@section('content')
    <section class="section">
        <div class="section-header">
            <div class="row">
                <h3 class="page__heading col-4">Editar Técnico</h3>
                <div class="col-4"></div>
                <div class="col-4">
                    @php
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        {!! Form::model($tecnico, ['method' => 'PATCH','route' => ['tecnicos.update', $tecnico->id]]) !!}
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sucursal_id" id="sucursal_id" class="form-control select2bs4 @error('sucursal_id') is-invalid @enderror">
                                        ...
                                        @foreach ($sucursales as $sucursal)
                                            <option value="{{$sucursal->id}}" {{ $tecnico->sucursal_id == $sucursal->id ? 'selected=selected':''}}>{{$sucursal->nombre}}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
